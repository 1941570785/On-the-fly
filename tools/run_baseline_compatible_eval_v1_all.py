...
EXPERIMENT_LABEL = os.environ.get(
    "OTF_EXPERIMENT_LABEL", "baseline-compatible-eval-v1_all"
)
OUT_ROOT = REPO / "results/BRANCH_EXPERIMENTS_20260619" / EXPERIMENT_LABEL
...
MODE = os.environ.get("OTF_DIRECT_DENSITY_MODE", "pose_rep_streaming_memory_v1")
