...
def main() -> int:
    ...
    growth_recent = final_keyframes
    starvation_risk = bool(density < 28.0 or final_keyframes < 90)
    plateau = False
    ...
    stability = {
        ...
        "keyframe_growth_recent": growth_recent,
        "starvation_risk": starvation_risk,
        "keyframe_growth_plateau": plateau,
    ...
    (out_dir / "report.md").write_text(
        "\n".join(
            [
                ...
                f"- keyframes_per_100_frames: {density:.3f}",
